...
const reasons = [
  {
    title: "Strategic Criminal Defense Representation",
    description:
      "Attorney David Liberty takes a strategic approach to every case, carefully analyzing the facts and developing a defense tailored to your specific circumstances.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Liberty Law P.C. proudly represents clients throughout Naperville, DuPage, Will, Kane, Kendall, DeKalb, and Grundy Counties, providing dedicated criminal defense for both felony and misdemeanor charges.",
  },
];
...
export const CriminalLawyerLP = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-white pb-[60px] font-outfit text-[#04304c] sm:pb-0">
      <Helmet>
        <title>Naperville Criminal Defense Lawyer | Liberty Law P.C.</title>
        <meta
          name="description"
          content="Liberty Law P.C. provides strategic felony and misdemeanor criminal defense in Naperville and DuPage County, Illinois. Book a free consultation."
        />
        <meta property="og:title" content="Naperville Criminal Defense Lawyer | Liberty Law P.C." />
        <meta
          property="og:description"
          content="Relentless criminal defense protecting your freedom, reputation, and future."
        />
        ...
        <section className="bg-[#f4f6f3] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="font-display mt-3 text-4xl sm:text-5xl">How We Help With Your Criminal Defense</h2>
            </div>
          ...
          <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
            <div className="relative flex min-h-[540px] items-end justify-center overflow-hidden bg-[#04304c] px-8 pt-12 lg:min-h-[680px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-t from-[#04304c] via-[#04304c]/60 to-transparent px-8 pb-8 pt-20 text-white">
                ...
                <p className="mt-1 text-sm uppercase tracking-[0.18em] text-white/70">Criminal Defense Attorney</p>
              </div>
            </div>
            ...
            <div className="flex items-center px-4 py-16 sm:px-10 lg:px-16 lg:py-20">
              <div>
                ...
                <p className="mt-5 text-lg leading-8 text-slate-600">
                  Facing criminal, felony, or misdemeanor charges is serious. Here's what sets our defense apart.
                </p>
        ...
        <section className="bg-[#EC3024] px-4 py-14 text-white sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-7 lg:flex-row lg:items-center">
            <div className="max-w-3xl">
              ...
              <h2 className="font-display mt-2 text-4xl sm:text-5xl">Ready to Discuss Your Criminal Defense Case?</h2>
              <p className="mt-4 max-w-2xl leading-7 text-white/85">
                If you're facing felony or misdemeanor charges, don't wait to protect your future. Contact Attorney David Liberty at Liberty Law P.C. today to discuss your case and learn how we can defend your rights and pursue the best possible outcome.
              </p>
            </div>
      ...
      <footer className="bg-[#021f32] px-4 pb-8 pt-12 text-white sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 border-b border-white/15 pb-10 md:grid-cols-[1.3fr_1fr_1fr]">
          ...
          <div>
            <h3 className="font-display text-xl">Criminal Defense</h3>
            <p className="mt-4 leading-8 text-white/65">
              Felony Defense<br />
              Misdemeanor Defense<br />
              Criminal Investigations<br />
              Strategic Case Defense
            </p>
          </div>
          <div>
