...
export const WhyChooseUsSection = (): JSX.Element => {
  const features = [
    {
      icon: Scale,
      text: "When facing criminal charges or family law matters, you need experienced attorneys who understand what's at stake. Our team has helped hundreds of people charged with crimes in Illinois navigate the legal system."
    },
    {
      icon: Users,
    ...
    <section className="w-full bg-white pt-12 md:pt-20 pb-6 md:pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="font-body text-gray-600 text-center text-lg mb-12">
          Experienced legal defense defending your rights and freedom
        </p>
