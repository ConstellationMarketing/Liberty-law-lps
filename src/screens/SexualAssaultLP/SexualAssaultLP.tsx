...
const benefits = [
  {
    icon: Shield,
    title: "Sexual Assault Defense Representation",
    description:
      "If you've been accused of sexual assault, Liberty Law P.C. provides strategic legal defense focused on protecting your rights, reputation, freedom, and future.",
  },
  {
    icon: Gavel,
    title: "Personalized Sexual Assault Defense Strategies",
    description:
