...
const benefits = [
  {
    icon: Shield,
    title: "Defense for a Wide Range of Sex Crime Charges",
    description:
      "Whether you're facing allegations of sexual assault, aggravated sexual assault, criminal sexual abuse, indecent exposure, sexting charges, or internet sex crimes, Liberty Law P.C. provides strategic legal representation focused on protecting your rights, reputation, freedom, and future.",
  },
  {
    icon: Gavel,
    title: "Customized Defense Strategy for Your Case",
    description:
      "No two cases are alike. Attorney David Liberty carefully analyzes the evidence, identifies weaknesses in the prosecution's case, and develops a defense strategy tailored to the specific allegations and circumstances surrounding your case.",
  },
  {
    icon: Clock3,
    title: "Early Intervention Can Strengthen Your Defense",
    description:
      "The decisions made in the early stages of a sex crime investigation can significantly affect your case. Whether you've been contacted by law enforcement or formally charged, David Liberty acts quickly to protect your rights, preserve critical evidence, and pursue the strongest possible defense.",
  },
  {
    icon: UserCheck,
    title: "Committed Representation From Start to Finish",
    description:
      "Sex crime allegations can have lasting consequences for your freedom, career, and reputation. Throughout your case, you'll receive clear communication, practical legal guidance, and dedicated representation focused on achieving the best possible outcome.",
  },
];

const reasons = [
  {
    title: "Strategic Sexual Assault Defense",
    description:
  ...
  },
  {
    ...
    description:
      "Liberty Law P.C. proudly represents clients throughout Naperville, DuPage, Will, Kane, Kendall, DeKalb, and Grundy Counties, providing dedicated defense for individuals accused of sexual assault.",
  },
];
...
const ConsultationForm = (): JSX.Element => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      navigate("/thank-you?from=sexual-assault");
    } catch {
    ...
    <div id="consultation-form" className="relative scroll-mt-28">
      ...
      <div className="relative bg-white p-6 text-[#04304c] shadow-2xl sm:p-8">
        ...
        <form
          ...
          method="POST"
          action="/thank-you?from=sexual-assault"
          data-netlify="true"
...
export const SexualAssaultLP = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-white pb-[60px] font-outfit text-[#04304c] sm:pb-0">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8 lg:py-24">
            <div className="grid gap-12 lg:grid-cols-[1.08fr_.92fr] lg:items-center">
              ...
              <h1 className="font-display max-w-3xl text-4xl font-normal leading-[1.08] sm:text-5xl lg:text-[64px]">
                Strategic Defense Against <span className="text-[#EC3024]">Sexual Assault Charges</span>
              </h1>
        ...
        <section className="bg-[#f4f6f3] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="font-display mt-3 text-4xl sm:text-5xl">How We Help With Your Sexual Assault Defense</h2>
            </div>
          ...
          <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
            <div className="relative flex min-h-[540px] items-end justify-center overflow-hidden bg-[#04304c] px-8 pt-12 lg:min-h-[680px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-t from-[#04304c] via-[#04304c]/60 to-transparent px-8 pb-8 pt-20 text-white">
                ...
                <p className="mt-1 text-sm uppercase tracking-[0.18em] text-white/70">Sexual Assault Defense Attorney</p>
              </div>
            </div>
            ...
            <div className="flex items-center px-4 py-16 sm:px-10 lg:px-16 lg:py-20">
              <div>
                ...
                <p className="mt-5 text-lg leading-8 text-slate-600">
                  Facing sexual assault charges is serious. Here's what sets our defense apart.
                </p>
        ...
        <section className="bg-[#EC3024] px-4 py-14 text-white sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-7 lg:flex-row lg:items-center">
            <div className="max-w-3xl">
              ...
              <h2 className="font-display mt-2 text-4xl sm:text-5xl">Ready to Discuss Your Sexual Assault Defense Case?</h2>
              <p className="mt-4 max-w-2xl leading-7 text-white/85">
                If you've been accused of sexual assault, don't wait to protect your rights and your future. Contact Attorney David Liberty at Liberty Law P.C. today to discuss your case and learn how we can build a strong defense on your behalf.
              </p>
            </div>
      ...
      <footer className="bg-[#021f32] px-4 pb-8 pt-12 text-white sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 border-b border-white/15 pb-10 md:grid-cols-[1.3fr_1fr_1fr]">
          ...
          <div>
            <h3 className="font-display text-xl">Sexual Assault Defense</h3>
            <p className="mt-4 leading-8 text-white/65">
              Sexual Assault Defense<br />
