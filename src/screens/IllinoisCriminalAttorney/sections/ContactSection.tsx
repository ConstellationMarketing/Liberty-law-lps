          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-wosnik-accent hover:bg-wosnik-accent/80 text-wosnik-dark font-inter font-medium text-sm px-8 py-3 rounded-full border border-wosnik-accent transition-all duration-150 uppercase tracking-[2px]"
                >
                  Send Message
                </button>
              </div>
